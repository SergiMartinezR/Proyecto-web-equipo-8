...
<body>
    ...
    <nav class="nav-wrapper blue darken-3" role="navigation">
        <div class="nav-wrapper container ">
            <a id="logo-container" href="../index.html" class="brand-logo white-text"><img src="../recursos/logoESCOMIPN.png" width="85%" height="85%"></a>
        ...
        <div class="row">
            ...
            <form action="verfDatos.php" class="col s12" id="formulario" name="formulario" method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12" id="grupo_alcaldia" r>
                            <select name="alcaldia" id="alcaldia" class="browser-default">
                                <?php
                                $listaAlcaldias = array(
                                    "Álvaro Obregón", "Azcapotzalco", "Benito Juárez", "Coyoacán",
                                    "Cuajimalpa", "Cuauhtémoc", "Gustavo A. Madero", "Iztacalco", "Iztapalapa", "Magdalena Contreras",
                                    "Miguel Hidalgo", "Milpa Alta", "Tláhuac", "Tlalpan", "Venustiano Carranza", "Xochimilco"
                                );
                                $listaNombreAlcaldia = array(
                                    "&Aacute;lvaro Obreg&oacute;n", "Azcapotzalco", "Benito Ju&aacute;rez", "Coyoac&aacute;n",
                    ...
                    <div class="row">
                        <div class="input-field col s12" id="grupo_escuela">
                            ...
                            <select name="escuela" id="escuela" class="browser-default" onchange="showNomEsc(this)">
                                <?php
                                $listaEscuelas = array(
                                    "CECyT 1", "CECyT 2", "CECyT 3", "CECyT 4",
                                    ...
                                    <div class="input-field col s12" id="grupo_entidad">
                                        <select id="entidad" name="entidad" class="browser-default">
                                            ...
                                            $listaEntidades = array(
                                                "Aguascalientes", "Aguascalientes", "Baja California", "Baja California Sur",
                ...
                <div class="row">
                    ...
                    <div class="col s2">
                        <!---Boton para enviar-->
                        <button class="btn waves-effect colorEscom1 right" type="submit" name="action">Enviar
